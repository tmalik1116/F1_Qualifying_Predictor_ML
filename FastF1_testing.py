...
def get_data() -> pd.DataFrame:
    ...
    # print(lap_data["target_time"])

    # print(len(lap_data))
    # for item in lap_data:
    #     print(len(lap_data[item]))
