...
def get_data() -> pd.DataFrame:
    for j in range(22): # Loop through
        ...
        for k in range(len(drivers)):
            ...
            # Skip entry if driver is not one of the 20 current drivers
    ...
    # second loop for 2024
    for j in range(14): # Loop through

        session = fastf1.get_session(2024, j+1, "Q") # starting with 2023
        session.load()
